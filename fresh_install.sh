...
wget -q https://raw.githubusercontent.com/vaniusha3/ionus/master/install_panel.php -O install_panel.php > /dev/null
/usr/bin/php install_panel.php
echo "FOS-Streaming -> Database Deployment"
wget -q https://raw.githubusercontent.com/vaniusha3/ionus/master/db_install.sh -O db_install.sh > /dev/null 
chmod 755 db_install.sh > /dev/null
./db_install.sh
if [ ! -f /usr/bin/ffmpeg ]; then
echo "FOS-Streaming -> FFmpeg and FFprobe installation"
wget -q https://raw.githubusercontent.com/vaniusha3/ionus/master/ffmpeg_install.sh -O ffmpeg_install.sh > /dev/null
